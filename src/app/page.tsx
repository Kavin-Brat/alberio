      ...
      <section className="relative w-full pt-10 pb-16 md:pt-16 md:pb-24 px-4 sm:px-6 lg:px-8 border-b border-slate-200/20 dark:border-slate-800/10 scroll-mt-20">
        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="mt-16 w-full max-w-5xl border-t border-b border-slate-200/20 dark:border-white/5 py-6 px-4 grid grid-cols-1 md:grid-cols-3 gap-6 bg-white/5 dark:bg-white/5 backdrop-blur-sm rounded-xl">
            <div className="flex flex-col items-center border-b md:border-b-0 md:border-r border-border-custom/40 pb-6 md:pb-0">
            ...
            <div className="flex flex-col items-center border-b md:border-b-0 md:border-r border-border-custom/40 pb-6 md:pb-0 pt-2 md:pt-0">
        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 flex flex-col gap-5 text-center lg:text-left items-center lg:items-start">
            ...
            <div className="flex flex-col gap-3 mt-2 w-full max-w-md">
              <div className="flex items-center gap-3 text-sm text-text-primary justify-center lg:justify-start">
          ...
          <div className="flex flex-col gap-16 md:gap-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative">
              ...
              <div className="relative pl-6 md:pl-12 border-l border-border-custom md:border-l-0">
                ...
                <div className="bg-slate-50/20 dark:bg-slate-900/10 backdrop-blur-sm border border-slate-200/30 dark:border-slate-800/40 p-5 rounded-xl max-w-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative">
              ...
              <div className="order-2 md:order-1 relative md:text-right pr-6 md:pr-12 md:border-r border-border-custom border-l md:border-l-0 pl-6 md:pl-0">
                ...
                <div className="bg-slate-50/20 dark:bg-slate-900/10 backdrop-blur-sm border border-slate-200/30 dark:border-slate-800/40 p-5 rounded-xl max-w-sm inline-block md:text-left">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-text-muted">Key Metric</span>
                  <p className="text-sm font-bold text-text-primary mt-1 leading-normal">
          ...
          <div className="mt-20 flex flex-col items-center border-t border-border-custom/40 pt-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-6">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 border border-slate-200/20 dark:border-white/10 rounded-full bg-white/5 dark:bg-white/5 backdrop-blur-sm hover:bg-white/10 text-text-muted hover:text-text-primary text-xs font-semibold transition-all duration-200"
              >
