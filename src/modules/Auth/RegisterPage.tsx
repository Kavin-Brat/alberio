...
/**
 * Dedicated Auth Module - Register Page Component
    ...
    <PublicRoute redirectIfAuthenticated>
      <PageContainer>
        <div className="max-w-md mx-auto w-full font-sora py-8">
          ...
          <div className="lg:hidden">
            <GlassCard className="p-8 border-[#00FF00]/40 bg-[#0b0b0b] text-center flex flex-col items-center gap-4 rounded-2xl shadow-2xl">
              ...
              <p className="text-xs text-slate-400 font-light leading-relaxed">
                The Albireo Trading Cockpit & Executive Command Center are optimized exclusively for desktop displays. Mobile registration is temporarily restricted for risk safety.
              </p>
          ...
          {/* STANDALONE DESKTOP REGISTER PAGE (>=1024px) */}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="email"
                      required
                      placeholder="alex.trader@gmail.com"
                      value={email}
