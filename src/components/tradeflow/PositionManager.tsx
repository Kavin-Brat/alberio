 ...
 * - Single Responsibility Principle (SRP): Displays active trade positions and closed trade history,
 *   delegating position row rendering to PositionTableRow sub-component.
 */
